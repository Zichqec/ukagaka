var item_tags = [
	...
	["Made for a ghost","Balloon pack"],
	["Pixel brush","Soft brush"],
	["Plain text area","Patterned text area","Dark text on light background","Light text on dark background"],
